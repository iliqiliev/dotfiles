...
Set-ItemProperty $REG_PATH "DisabledHotkeys" "V" # Free Super+V shortcut for external clipboard manager.
Set-ItemProperty $REG_PATH "Hidden"           1  # Show hidden files and folders in explorer.
Set-ItemProperty $REG_PATH "HideFileExt"      0  # Show file extensions in explorer.
